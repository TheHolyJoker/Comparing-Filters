...
#ifndef FILTERS_HASHTABLE_BATCHPACKING_HPP
#define FILTERS_HASHTABLE_BATCHPACKING_HPP
...
constexpr auto get_l2_MainBucket_bit_size() {
    ...
    constexpr size_t rem_part = bits_per_item * bucket_capacity;
...
public:
    hashTable_BatchPacking(size_t max_capacity, size_t element_length, double max_load_factor)
    ...
    virtual ~hashTable_BatchPacking() {
        delete[] Table;
    }
...
#endif//FILTERS_HASHTABLE_BATCHPACKING_HPP
