...
auto v_hash_table(size_t reps, size_t table_size, size_t max_capacity, size_t element_length, double load_factor) -> bool;
...
void single_op(HashTable *ht, unordered_set<slot_type> *my_set, unordered_set<slot_type> *out_set,
    ...
    std::unordered_set<all_map::uset_t> *source_set;
    std::unordered_set<all_map::uset_t> *dest_set;
    if (to_insert) {
        source_set = out_set;
        dest_set = in_set;
    } else {
