...
#ifndef FILTERS_DICT512_VER4_HPP
#define FILTERS_DICT512_VER4_HPP
...
public:
    Dict512_Ver4(size_t max_number_of_elements, double level1_load_factor, double level2_load_factor)
    ...
    inline auto lookup(const itemType s) const -> bool {
        ...
        // One level search
        // return (pd512_plus::pd_find_50_v25(quot, rem, &pd_array[pd_index])) || pd512_plus::cmp_qr_smart(qr, &pd_array[pd_index]);

        // One level search
        // faster
        // return pd512_plus::pd_find(quot, rem, &pd_array[pd_index]) != pd512_plus::pd_Status::No;

        // slower
        // return pd512_plus::pd_find3(quot, rem, &pd_array[pd_index]) != pd512_plus::pd_Status::No;

        // Two level search
        // const pd512_plus::pd_Status lookup_res = pd512_plus::pd_find(quot, rem, &pd_array[pd_index]);
        // switch (lookup_res)
        // {
        ...
        //     return spare_filter.Contain(((uint64_t) pd_index << (14)) | qr) == cuckoofilter::Ok;
        // default:
        //     assert(0);
        //     return false;
        //     break;
        ...
        // Two level search
        // return (pd512_plus::pd_find_50_v25(quot, rem, &pd_array[pd_index])) ||
        //    (pd512_plus::cmp_qr_smart(qr, &pd_array[pd_index]) && (spare_filter.Contain(((uint64_t) pd_index << (14)) | qr)) == cuckoofilter::Ok);

        //Two level search Worst Case
        // return (pd512_plus::pd_find_50_v25(quot, rem, &pd_array[pd_index])) || ((spare_filter.Contain(((uint64_t) pd_index << (14)) | qr)) == cuckoofilter::Ok);
        ...
        // return pd512_plus::pd_find_50_v25(quot, rem, &pd_array[pd_index + rand_vec[pd_index]]);
        // return (rand_vec[pd_index]) ? pd512_plus::pd_find_50_v25(quot, rem, &pd_array[pd_index]) : pd512_plus::pd_find_50_v25(quot, rem, &pd_array[pd_index + 1]);

        // return (rand_vec[pd_index]) ? pd512_plus::pd_find_50_v25(quot, rem, &pd_array[pd_index]) : spare_filter.Contain(((uint64_t) pd_index << (14)) | qr) == cuckoofilter::Ok;
        // return (rand_vec[pd_index]) ? pd512_plus::pd_find_50_v25(quot, rem, &pd_array[pd_index + 1]) : pd512_plus::pd_find_50_v25(quot, rem, &pd_array[pd_index]);
        // return (rand_vec[pd_index]) ? pd512_plus::pd_find_50_v25(quot, rem, &pd_array[pd_index + 1]) : pd512_plus::pd_find_50_v25(quot, rem, &pd_array[pd_index]);
        // return pd512_plus::pd_find_50_v25(quot, rem, &pd_array[pd_index + rand_vec[pd_index]]);

        // if (rand_vec[pd_index])
        //     return pd512_plus::pd_find_50_v25(quot, rem, &pd_array[pd_index]);
        // else
        //     return spare_filter.Contain(((uint64_t) pd_index << (14)) | qr) == cuckoofilter::Ok;

        // const bool ind = rand_vec[pd_index];
        // return (ind && pd512_plus::pd_find_50_v25(quot, rem, &pd_array[pd_index])) || (!ind && ((spare_filter.Contain(((uint64_t) pd_index << (14)) | qr)) == cuckoofilter::Ok));
    ...
    auto get_name() -> std::string {
        // return "Dict512_Ver4 find_21";
        // return "Dict512_Ver4 find_18";
        return "Dict512_Ver4";
        /* string a = "dict512:\t";
...
#endif//FILTERS_DICT512_VER4_HPP
