...
#include <cmath>
#include <climits>
#include "../PD_Filter/macros.h"
#include "../PD_Filter/hashutil.hpp"
...
public:
    ...
    {
        /* I think the problem is el3002 looks like an empty slot. Anyway, this element erases it somehow.  */
        bucket_type bad_hombre = 1292314482ul;
...
*/
    ...
    */
    ...
    auto h() -> bool
    {
        return in_which_bucket_is_the_element(60481692) != -1;
    }
