...
public:
    att_d512(size_t max_number_of_elements, double level1_load_factor, double level2_load_factor)
        : number_of_pd(compute_number_of_PD(max_number_of_elements, max_capacity, level1_load_factor)), pd_index_length(ceil_log2(compute_number_of_PD(max_number_of_elements, max_capacity, level1_load_factor))), sparse_element_length(pd_index_length + quotient_length + remainder_length)
    {
        ...
        */
        int ok = posix_memalign((void **)&pd_array, 512, 512 * number_of_pd);
